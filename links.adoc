...
:uri-ubuntu: http://ubuntu.com
:uri-jruby: http://jruby.org
:uri-targetprocess: http://www.targetprocess.com
:uri-scrum: http://www.desenvolvimentoagil.com.br/scrum/
:uri-travis-ci: http://travis-ci.org
:uri-trello: https://trello.com
:uri-jboss-forge: http://forge.jboss.org
:uri-jboss-tools: http://tools.jboss.org/
:uri-jboss-devstudio: http://tools.jboss.org/downloads/devstudio/index.html
...
:uri-rest: http://en.wikipedia.org/wiki/REST
:uri-javaee-specification: https://java.net/projects/javaee-spec/pages/Home
:uri-angularjs: http://angularjs.org
:uri-vim: http://vim.org
:uri-openjdk: http://openjdk.java.net/
:uri-oracle-jdk: http://www.oracle.com/technetwork/java/javase/downloads/index.html
:uri-junit: http://junit.org
:uri-eclipse: http://eclipse.org
...
:uri-sislegis-ambiente-ubuntu: {uri-sislegis}/sislegis-ambiente-ubuntu
